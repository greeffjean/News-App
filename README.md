## Project Title
News-App - News web application, connected to News API, explore a wide range of news articles, search titles. filter results by date.

## Prerequisites
You will need a internet connection, Node.js installed on your computer.
